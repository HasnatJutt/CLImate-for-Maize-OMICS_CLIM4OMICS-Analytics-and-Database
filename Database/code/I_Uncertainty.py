...
if args.input is not None:
    ...
    if args.output2 is not None:
        ...
        Output_path2 = '../../Database/output/I/uncertainty_plots'
        Output_dir2 = output_fdir(Output_path2)
elif os.path.exists("Database/output/All_Files"):
    Input_dir = "Database/output/All_Files"
    if os.path.exists("APIs/NSRDB/output/NSRDB"):
...
#ax.text (-350, 0.0097, '$SD_{G2F-NSRDB}$' + " = " + str (round (SD_1, 2)), fontsize = 10)
...
#ax.text (-350, 0.0090, '$SD_{G2F-NWS}$' + " = " + str (round (SD_3, 2)), fontsize = 10)
...
plt.title('$SD_{G2F-NSRDB}$' + " = " + str (round (SD_1, 2))+"  ,  "+'$SD_{G2F-NWS}$' + " = " + str (round (SD_3, 2)))
plt.xlabel ("Err-I")
plt.ylabel ("Density")
plt.legend () 
#plt.title ("Error")
