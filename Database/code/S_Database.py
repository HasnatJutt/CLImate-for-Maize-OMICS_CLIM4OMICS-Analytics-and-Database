...
if args.input is not None:
    ...
    if os.path.exists(Input_path):
        ...
        if args.output1 is not None:
            ...
            Output_path1 = os.path.join(Input_path, '../../../../Database/output/S/output')
            Output_dir1 = output_fdir(Output_path1)
            Output_path2 = os.path.join(Input_path, '../../../../Database/output/S/plots')
            Output_dir2 = output_fdir(Output_path2)
            Output_path3 = os.path.join(Input_path, '../../../../Database/output/S/complete')
            Output_dir3 = output_fdir(Output_path3)
            Output_path4 = os.path.join(Input_path, '../../../../Database/output/S/empty')
            Output_dir4 = output_fdir(Output_path4)
            Output_path5 = os.path.join(Input_path, '../../../../Database/output/S/enough')
            Output_dir5 = output_fdir(Output_path5)
            Output_path6 = os.path.join(Input_path, '../../../../Database/output/S/not_enough')
            Output_dir6 = output_fdir(Output_path6)
            Output_path7 = os.path.join(Input_path, '../../../../Database/output/S/less')
            Output_dir7 = output_fdir(Output_path7)
            Output_path8 = os.path.join(Input_path, '../../../../Database/output/S/more')
            Output_dir8 = output_fdir(Output_path8)
            Output_path9 = os.path.join(Input_path, '../../../../Database/output/S/no_lat_lon')
            Output_dir9 = output_fdir(Output_path9)
    ...
    if args.output1 is not None:
        ...
        Output_path1 = '../../Database/output/S/output'
        Output_dir1 = output_fdir(Output_path1)
    if args.output2 is not None:
        Output_dir2 = output_fdir(args.output2)
    else:
        Output_path2 = '../../Database/output/S/plots'
        Output_dir2 = output_fdir(Output_path2)
    if args.output3 is not None:
        Output_dir3 = output_fdir(args.output3)
    else:
        Output_path3 = '../../Database/output/S/complete'
        Output_dir3 = output_fdir(Output_path3)
    if args.output4 is not None:
        Output_dir4 = output_fdir(args.output4)
    else:
        Output_path4 = '../../Database/output/S/empty'
        Output_dir4 = output_fdir(Output_path4)
    if args.output5 is not None:
        Output_dir5 = output_fdir(args.output5)
    else:
        Output_path5 = '../../Database/output/S/enough'
        Output_dir5 = output_fdir(Output_path5)
    if args.output6 is not None:
        Output_dir6 = output_fdir(args.output6)
    else:
        Output_path6 = '../../Database/output/S/not_enough'
        Output_dir6 = output_fdir(Output_path6)
    if args.output7 is not None:
        Output_dir7 = output_fdir(args.output7)
    else:
        Output_path7 = '../../Database/output/S/less'
        Output_dir7 = output_fdir(Output_path7)
    if args.output8 is not None:
        Output_dir8 = output_fdir(args.output8)
    else:
        Output_path8 = '../../Database/output/S/more'
        Output_dir8 = output_fdir(Output_path8)
    if args.output9 is not None:
        Output_dir9 = output_fdir(args.output9)
    else:
        Output_path9 = '../../Database/output/S/no_lat_lon'
        Output_dir9 = output_fdir(Output_path9)
    if args.output10 is not None:
        Output_dir10 = output_fdir(args.output10)
    else:
