...
if args.input is not None:
    ...
    if os.path.exists(Input_path):
        ...
        if args.output is not None:
            ...
            Output_path = os.path.join(Input_path, '../../../ML/ANN/output/D/pairplots')
...
elif os.path.exists("../../../Database/output/D/more"):
    Input_dir = "../../../Database/output/D/more"
    if args.output is not None:
        Output_dir = output_fdir(args.output)
    else:
        Output_path = '../../../ML/ANN/output/D/pairplots'
        Output_dir = output_fdir(Output_path)
elif os.path.exists("Database/output/D/more"):
    Input_dir = "Database/output/D/more"
    if args.output is not None:
