...
if args.input is not None:
    ...
    if os.path.exists(Input_path):
        ...
        if args.output is not None:
            ...
            Output_path = os.path.join(Input_path, '../../../ML/ANN/output/S/pairplots')
...
elif os.path.exists("../../../Database/output/S/more"):
    Input_dir = "../../../Database/output/S/more"
    if args.output is not None:
        Output_dir = output_fdir(args.output)
    else:
        Output_path = '../../../ML/ANN/output/S/pairplots'
        Output_dir = output_fdir(Output_path)
elif os.path.exists("Database/output/S/more"):
    Input_dir = "Database/output/S/more"
    if args.output is not None:
...
# =============================================================================        
df = pd.DataFrame (list(zip(Experiments_list, RMSE_list, RMSE_list_Max)), columns = ["Experiment_ID", "RMSE", "RMSE_Max"])  
df.plot.density ()
plt.title ("RMSE")
