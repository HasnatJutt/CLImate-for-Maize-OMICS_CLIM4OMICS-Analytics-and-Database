...
if args.input is not None:
    ...
    if os.path.exists(Input_path):
        ...
        if args.output is not None:
            ...
            Output_path = os.path.join(Input_path, '../../../ML/ANN/output/T/pairplots')
...
elif os.path.exists("../../../Database/output/T/more"):
    Input_dir = "../../../Database/output/T/more"
    if args.output is not None:
        Output_dir = output_fdir(args.output)
    else:
        Output_path = '../../../ML/ANN/output/T/pairplots'
        Output_dir = output_fdir(Output_path)
elif os.path.exists("Database/output/T/more"):
    Input_dir = "Database/output/T/more"
    if args.output is not None:
